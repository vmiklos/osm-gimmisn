...
házszámokat felmérni. A főoldalnak 3 oszlopa van:
...
a házszámokra.  Ezzel neked nem kell foglalkoznod (kivéve ha helyben szeretnél tesztelni, kézzel
generálva a referenciát), a pull request jóváhagyásakor ez a generálás megtörténik a
