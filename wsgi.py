    ...
    if action == "view-query":
        ...
        try:
            ...
            if streets != "only":
                ...
                link = config.Config.get_uri_prefix() + "/missing-housenumbers/" + relation_name + "/view-result"
...
def get_handler(request_uri: str) -> Optional[Callable[[config.Config2, areas.Relations, str], yattag.doc.Doc]]:
