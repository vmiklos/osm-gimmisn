...
sed "s/@RELATION@/$value/g" ../data/street-housenumbers-template.txt > street-housenumbers-"$name".txt
...
sed "s/@RELATION@/$value/g" ../data/streets-template.txt > streets-"$name".txt
