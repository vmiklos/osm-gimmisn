...
class TestRange(unittest.TestCase):
    ...
    def test_eq(self) -> None:
        ...
        self.assertTrue(make_range(1, 3) != rust.PyRange(1, 3, interpolation="all"))

    def test_interpolation_all(self) -> None:
        """Tests the interpolation modes."""
        self.assertFalse(2 in make_range(1, 3))
        self.assertTrue(2 in rust.PyRange(1, 3, interpolation="all"))
...
class TestRanges(unittest.TestCase):
    ...
    def test_a(self) -> None:
        ...
        test = rust.PyRanges([make_range(0, 0), make_range(1, 1)])
    ...
    def test_ab(self) -> None:
        ...
        test = rust.PyRanges([make_range(1, 1), make_range(1, 1)])
        self.assertTrue(1 in test)
